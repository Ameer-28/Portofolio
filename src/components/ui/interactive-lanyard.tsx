...
function LanyardSkeleton() {
  return (
    <div
      className="relative w-full h-[520px] sm:h-[600px] flex flex-col items-center justify-center animate-pulse select-none"
      aria-hidden="true"
    >
      {/* Strap skeleton */}
      <div className="w-12 h-40 bg-neutral-900 border-x border-white/10 rounded-xs flex flex-col justify-around items-center py-4">
      ...
      {/* Card skeleton */}
      <div className="w-[245px] sm:w-[270px] h-[360px] sm:h-[390px] rounded-[22px] bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 p-4 flex flex-col items-center shadow-xl -mt-2">
        <div className="w-10 h-2.5 rounded-full bg-neutral-200 dark:bg-neutral-800 mb-3" />
        <div className="w-full flex-1 rounded-xl bg-neutral-100 dark:bg-neutral-800/60 mb-3" />
