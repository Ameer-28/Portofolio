...
export function ProfileCard({
  ...
  const handleDeviceOrientation = useCallback(
    (event: DeviceOrientationEvent) => {
      ...
      const x = clamp(
        cx + gamma * mobileTiltSensitivity,
        0,
        shell.clientWidth
      );
      const y = clamp(
  ...
  useEffect(() => {
    ...
    const onOrient = handleDeviceOrientation as EventListener;
  ...
  const cardStyle = useMemo(
    () =>
      ({
        ...
        "--behind-glow-color": behindGlowColor ?? "rgba(56, 189, 248, 0.55)",
      ...
      <div ref={shellRef} className="pc-card-shell">
        <section className="pc-card">
          <div className="pc-inside">
            ...
            {detailsPosition === "bottom" && <div className="pc-bottom-scrim" />}

            {/* Name / title layer */}
            <div className={`pc-content pc-details-content pc-details--${detailsPosition}`}>
